...
public class DBMovie implements Movie {
     ...
     * 
     * @return the year the movie was released. Will return -1 if this
     *         value is not set.
     */
    public int getYear() {
    ...
    /**
     * This will return the condition this movie is in (e.g. "It's got
     * a large scratch, and the case is broken")
     * 
    ...
    /**
     * Remove the specified change listener from the list of listeners
     * notified in the case of a change.
     * 
     * @param l
    ...
    /**
     * Notify all listeners that there has been a change in the state
     * of the object.
     */
    ...
    private class NotfullMovieState implements DBMovieState {
         ...
         */
        public List<String> getGenres() {
            return DBMovie.this.movieDAO
                    .getGenresForMovie(DBMovie.this);
        }
