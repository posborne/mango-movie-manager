...
public class H2ListsDAO implements ListsDAO {
    ...
    private H2ListsDAO() {
        ...
        try {
            ...
            addMovieToListPS = conn
                    .prepareStatement(addMovieToListSQL);
            highestOrderInListPS = conn
                    .prepareStatement(hightestOrderInListSQL);
            addListPS = conn.prepareStatement(addListSQL);
            listIdForLabelPS = conn
                    .prepareStatement(listIdForLabelSQL);
    ...
    /**
     * Retrieve the list of movies in the list with the specified
     * label.
     * 
     * @param label
     *            The label of the list we are interested in.
     * @return the list of all movies in the list with the specified
     *         label.
     */
    @Override
     ...
     * 
     * @param label
     *            Remove the list with the specified label from the
     *            database.
     */
    @Override
    ...
    /**
     * Reorder the movies in the list in the database to match the
     * order of the movies in the list passed in.
     * 
     * @param label
    ...
    public void addMovieToList(String label, Movie m) {
        ...
        try {
            ...
            addMovieToListPS.setInt(3,
                    getHighestOrderInList(label) + 1);
    ...
    /**
     * Add the specified change listener to the list that will be
     * notified when a change to this list of sets occurs.
     * 
     * @param l
    ...
    /**
     * Notify all the list listeners that the set of lists have
     * changed.
     */
