...
/**
 * The H2SetsDAO is an implementation of the SetsDAO specific to the
 * H2 database. These methods are responsible for doing different
 * database layer interactions involving sets.
 * 
 * @author Paul Osborne
 */
public class H2SetsDAO implements SetsDAO {
    ...
    /**
     * Private singleton constructor initializes different Prepared
     * Statements and other state for the singleton.
     */
    private H2SetsDAO() {
        ...
        try {
            ...
            removeSetFromSetContentsPS = conn
                    .prepareStatement(removeSetSQL);
            removeSetFromSetsPS = conn
                    .prepareStatement(removeSetFromSetsSQL);
            removeMovieFromSetPS = conn
                    .prepareStatement(removeMovieFromSetSQL);
