...
/**
 * This is an interface for an actor data access object (DAO). This is
 * an interface that provides methods to manipulate actors however
 ...
 * (e.g. an H2 database, or a derby databse, etc.)
 * 
...
public interface ActorDAO {
     ...
     * 
     * @param actor
     *            the Actor whose roles this will return
     ...
     * 
     * @param firstName
     *            the first name of the actor to be saved
     * @param lastName
     *            the last name of the actor to be saved
     * @return false if there was an error saving the actor true
     *         otherwise.
     */
    public boolean addActor(String firstName, String lastName);

    /**
     * This will update all of the information stored about a given
     * actor.
     * 
     * @param actor
    ...
    /**
     * This will forcably delete the actor from all associations it is
     * a part of
     * 
     * @param actor
    ...
    /**
     * This will delete an actor if it is not a part of any other
     * relationships. If the actor exists elsewhere this will throw an
     * ActorExistsInOtherRelationsException.
     * 
     * @param actor
     *            the actor to attempt to delete
     * 
     * @throws com.themangoproject.db.h2.ActorExistsInOtherRelationsException
     *             if the actor exists in other relations.
     */
     ...
     * 
     * @param actor
     *            the actor for whom the movies are wanted.
     ...
     * 
     * @param role
     *            the new role this actor is a part of
     * @throws com.themangoproject.model.RoleNotFoundException
     *             if the role passed doesn't already exist in the
     *             storage model.
     */
