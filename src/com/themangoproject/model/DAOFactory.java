...
/**
 * This is an interface for a DAOFactory. A concrete implementation of
 * this class would be able to provide a DAO for any type of object
 * for a given storage method (e.g. an H2 database, a derby database,
 * etc.).
 * 
