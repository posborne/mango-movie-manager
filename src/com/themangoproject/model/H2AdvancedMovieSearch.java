...
/**
 * This is a class that is used to build and save advanced search
 * criteria for movies using an H2 database.
 * 
 * @author Paul Osborne
 */
public class H2AdvancedMovieSearch {
     ...
     * 
     * @param condition
     *            the new SearchCondition to be considered in this
    ...
    /**
     * This will return a String that is an H2 query that will
     * retrieve all items in the movie table that match the
     * SearchConditions that have been added as a part of this
     * H2AdvancedMovieSearch
     * 
