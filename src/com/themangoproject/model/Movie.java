...
/**
 * This is a generic interface to represent a movie.  A movie consists of a 
...
public interface Movie {
    ...
    /**
     * @return a String that is the rating (e.g. PG, R, PG-13) of this movie
     */
    ...
    /**
     * @return an int that is the mango rating (e.g. 0-5 mangoes) of this movie
     */
    ...
    /**
     * 
     * @param rating the new rating (e.g. PG, R, PG-13) of this movie
     */
    public void setRating(String rating);
    /**
     * 
     * @param minutes the new runtime (in minutes) of this movie
     */
    public void setRuntime(int minutes);
    /**
     * 
     * @param year the new year of this movie
     */
    public void setYear(int year);
    /**
     * 
     * @param asin the new ASIN of this movie
     */
    public void setASIN(String asin);
    /**
     * 
     * @param condition the new condition of this movie
     */
    public void setCondition(String condition);
    /**
     * 
     * @param purchaseDate the new purchase date of this movie
     */
    ...
    /**
     * 
     * @param type the new type (e.g. DVD, VHS) of this movie
     */
    public void setType(String type);
    /**
     * 
     * @param mangoRating the new mango rating (e.g. 0-5 mangoes) of this movie
     */
    public void setMangoRating(int mangoRating);
    /**
     * 
     * @param owner the new owner of this movie
     */
    public void setOwner(Person owner);
    /**
     * 
     * @param borrower the new borrower of this movie
     */
    public void setBorrower(Person borrower);
    /**
     * This adds a genre to this movie.
     * @param genre the new genre to be added to this movie
     */
    public void addGenre(String genre);
    /**
     * This will remove a genre from this movie
     * @param genre the genre to be removed from this movie
     */
     ...
     * 
     * @param l the ChangeListener to add to this movie
     */
    public void addChangeListener(ChangeListener l);
    /**
     * This will remove a ChangeListener from this movie.
     * 
     * @param l the ChangeListener to remove from this movie
     */
