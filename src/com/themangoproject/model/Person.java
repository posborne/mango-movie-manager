...
/**
 * This is a generic interface to represent a person. A person
 * consists of a a name, address, phone number, and e mail address.
 * 
...
public interface Person {
    ...
    /**
     * @param address
     *            the new address of this person
     */
    ...
    /**
     * @param phoneNumber
     *            the new phone number of this person.
     */
    ...
    /**
     * @param email
     *            the new email of this person
     */
    public void setEmail(String email);

    /**
     * @return a List of all the movies for which this person is the
     *         owner
     */
     ...
     * borrowing to the owner.
     * 
     * @param movie
     *            the movie to be returned.
     */
