...
public interface SearchDAO {
     ...
     * @throws SQLException
     *             if there is a problem with the saved search
     *             execution
     */
    ...
    /**
     * @return a list of all the labels of the saved searches in the
     *         database.
     */
     ...
     * 
     * @param searchLabel
     *            The label of the saved search that should be
     *            removed.
     */
    ...
    /**
     * Add the specified listener as a change listener for when saved
     * searches are added or removed.
     * 
     * @param l
