...
/**
 * SetsDAO is an interface which is a data access object for sets.  Sets are
 * lists that do not contain duplicates.  The SetsDAO provides methods to
 * access information from a DBMS.  A concrete implementation of this class will
 * will implement these methods for their specific database.
 * 
...
public interface SetsDAO {
    ...
    /**
     * MovieExistsInSetException is an exception that is thrown when a set
     * already contains the movie which is trying to be added.
     * 
     * @author Paul Osborne
     */
    ...
    /**
     * Gets a list of movies that belong to a set with lable <code>label</code>.
     * 
    ...
    /**
     * Removes a set from the database that has the label <code>label</code>.
     * 
     * @param label The label of the set to remove.
     */
    public void removeSet(String label);
    
    /**
     * Removes a movie <code>m</code> from a set with label <code>label</code>.
     * 
     * @param label The label of the set.
     * @param m The movie to remove from the set <code>label</code>.
     */
     ...
     * 
     * @param label The label of the set.
     * @param m The movie to add to the set.
     * @throws MovieExistsInSetException If the set already contains the movie
     * <code>m</code>.
     */
    ...
    /**
     * Rename a set with label <code>oldLabel</code> to be named <code>newLabel
     * </code>
     * 
     * @param oldLabel The name of the old label
