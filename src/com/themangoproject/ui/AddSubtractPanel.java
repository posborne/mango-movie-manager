...
public class AddSubtractPanel extends javax.swing.JPanel {
    ...
    public AddSubtractInnerPanel addAddSubPanel() {
        ...
        try {
            asip = new AddSubtractInnerPanel(this.cbm1.getClass()
                    .newInstance(), this.cbm2.getClass()
                    .newInstance());
        ...
        if (this.jPanel1.getComponentCount() == 3)
            ((AddSubtractInnerPanel) this.jPanel1.getComponent(0))
                    .enableMinusButton();
     ...
     * 
     * @param a
     *            The AddSubtractInnerPanel to remove from this panel.
     */
    ...
    /**
     * Sets the ComboBoxModels that should be assigned to each new
     * panel and sets the property of each ComboBoxes editable state.
     * 
     * @param cbm1
     *            The first ComboBoxModel
     * @param cbm2
     *            The second ComboBoxModel
     * @param cb1
     *            Set the left ComboBox editable if true.
     * @param cb2
     *            Set the right ComboBox editable if true.
     */
    public void setComboBoxPrefs(ComboBoxModel cbm1,
            ComboBoxModel cbm2, boolean cb1, boolean cb2) {
        this.cbm1 = cbm1;
        this.cbm2 = cbm2;
        this.cbEditable1 = cb1;
        this.cbEditable2 = cb2;
        AddSubtractInnerPanel asip = new AddSubtractInnerPanel(cbm1,
                cbm2);
        asip.disableMinusButton();
        asip.setComboBox1Editable(this.cbEditable1);
        asip.setComboBox2Editable(this.cbEditable2);
        this.jPanel1.add(asip);
        // Add a glue component to take up extra space so the panels
        // that
    ...
    /**
     * Gets the AddSubtractInnerPanels from this panel. These panels
     * contain information usefull for searches and other actions.
     * 
    ...
    public List<AddSubtractInnerPanel> getInnerPanelsValues() {
        ...
        for (int i = 0; i < this.jPanel1.getComponentCount(); i++) {
            if (this.jPanel1.getComponent(i) instanceof AddSubtractInnerPanel)
                info.add((AddSubtractInnerPanel) this.jPanel1
                        .getComponent(i));
        }
        return info;
    }
    ...
    /**
     * Creates a new inner panel and trys to select an item with a
     * given name. This method is used when adding panels from a list
     * of panels. It will populate the panel that is already added if
     * it is empty.
     * 
     * @param name
     *            The name of the item.
     */
    public void createAndSetSelected(String name, String role,
            String text) {
        // This code will be relevant when the comboboxmodels become
        // listeners
        if (this.jPanel1.getComponentCount() == 2) {
            // This means there may only be one panel and it may be
            // empty.
            List<AddSubtractInnerPanel> info = this
                    .getInnerPanelsValues();
            JComboBox cb1 = (JComboBox) ((AddSubtractInnerPanel) info
                    .get(0)).getLeftComboObject();
            JComboBox cb2 = (JComboBox) ((AddSubtractInnerPanel) info
                    .get(0)).getRightComboObject();
            AddSubtractInnerPanel a = (AddSubtractInnerPanel) info
                    .get(0);
