...
public class SavedSearchDialog extends javax.swing.JDialog {
    ...
    public SavedSearchDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.addSubtractSearchPanel.setComboBoxPrefs(
                new AttributesComboBoxModel(),
                new ConstraintComboBoxModel(), false, false);
    }

    // Builds the advanced search
    private H2AdvancedMovieSearch buildAdvancedSearch() {
        List<AddSubtractInnerPanel> panels = this.addSubtractSearchPanel
        ...
        for (AddSubtractInnerPanel panel : panels) {
            ...
            JComboBox rightCB = (JComboBox) panel
                    .getRightComboObject();
            ...
            if (attribute == null || condtion == null
                    || value == null) {
            ...
            try {
                ...
                as.addSearchCondition(new SearchCondition(attribute,
                        condtion, intval));
    ...
    private void initComponents() {
        ...
        searchCriterionPanel.setBorder(javax.swing.BorderFactory
                .createEtchedBorder());
        ...
        javax.swing.GroupLayout searchCriterionPanelLayout = new javax.swing.GroupLayout(
                searchCriterionPanel);
        searchCriterionPanel.setLayout(searchCriterionPanelLayout);
        searchCriterionPanelLayout
                .setHorizontalGroup(searchCriterionPanelLayout
                        .createParallelGroup(
                                                        ...
                                                        .addGroup(
                                                                searchCriterionPanelLayout
                                                                        ...
                                                                        .addComponent(
                                                                                jLabel4))
                                                        .addComponent(
                                                                addSubtractSearchPanel,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                463,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addContainerGap()));
        searchCriterionPanelLayout
                .setVerticalGroup(searchCriterionPanelLayout
                        .createParallelGroup(
                                javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(
                                searchCriterionPanelLayout
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
                new java.awt.Component[] { cancelButton, closeButton,
                        saveButton });
    ...
    private void saveButtonActionPerformed(
        ...
        try {
            ...
            if (!searchLabel.equals("")) {
                MangoController.getInstance().saveSearch(searchLabel,
                        as.getSearchQuery());
                this.dispose();
            } else {
                JOptionPane.showMessageDialog(this,
                        "You cannot save with no name!",
        ...
        // UIController.getInstance().setViewTableModel(new
        // SavedSearchEditableTableModel(searchLabel));
    ...
    private void executeSearchButtonActionPerformed(
            java.awt.event.ActionEvent evt) {
        try {
            H2AdvancedMovieSearch as = buildAdvancedSearch();
            if (as.getSearchQuery() != null)
                UIController.getInstance().setViewTableModel(
                        new UnsavedSearchEditabledTableModel(as
                                .getSearchQuery()));
        } catch (IllegalArgumentException e) {
            JOptionPane.showMessageDialog(this, e.getMessage(),
                    "Invalid Input", JOptionPane.WARNING_MESSAGE);
