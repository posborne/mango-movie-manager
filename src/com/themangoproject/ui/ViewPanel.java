...
/**
 * ViewPanel is the main panel of the Mango program. There are action
 * buttons that allow the user to change the main panel view from
 * thumbnail to list view, search text within the main panel and
 * launch an advanced search option.
 * 
...
public class ViewPanel extends javax.swing.JPanel implements
    ...
    private void initComponents() {
        ...
        printButton
                .setIcon(new javax.swing.ImageIcon(
                        getClass()
                                .getResource(
                                        "/com/themangoproject/ui/images/printer.png"))); // NOI18N
        ...
        controlsPanelLayout.linkSize(
                ...
                new java.awt.Component[] { printButton, searchTF });
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(
                ...
                .addComponent(controlsPanel,
                        ...
                        tableScrollPane,
                        javax.swing.GroupLayout.DEFAULT_SIZE, 521,
                        Short.MAX_VALUE));
        layout
    ...
    private void searchTFFocusGained(java.awt.event.FocusEvent evt) {// GEN-FIRST:event_searchTFFocusGained
        // If text was previously added to the text field nothing
        // happens. If
        // The text is gray colored it will say "Search" and will be
        // replaced
        // with black text and an empty string
        if (this.searchTF.getForeground().equals(
    ...
    private void searchTFFocusLost(java.awt.event.FocusEvent evt) {// GEN-FIRST:event_searchTFFocusLost
        // Sets the text to read "Search" in gray color when focus is
        // lost if
    ...
    private void printButtonActionPerformed(
        ...
        try {
            ...
            viewTable.print(PrintMode.FIT_WIDTH, new MessageFormat(
                    "Mango Movie Manager"), null);
        } catch (PrinterException ex) {// GEN-LAST:event_printButtonActionPerformed
            Logger.getLogger(ViewPanel.class.getName()).log(
    ...
    /**
     * Set the table model to the specified model. When changing the
     * table model through this method any listeners that are out of
     * date will be removed from the current table and table models,
     * making it so there isn't memory being lost as a result of
     * listeners referencing items that will not be used again.
     * 
     * @param model
     *            The new table model.
     */
