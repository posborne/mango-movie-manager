...
/**
 * This combo box model gives encapsulates the list of all actors that
 * exist. The list should be automatically updated when the a method
 * to change the database occurs, and the client code can retrieve an
 * Actor object from the combo box model from its index.
 * 
...
public class ActorComboBoxModel extends DefaultComboBoxModel {
    ...
    public ActorComboBoxModel() {
        ...
        MangoController.getInstance().addActorsChangeListener(
                actorsChangeListener);
    }
