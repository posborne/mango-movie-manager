 ...
 * @author Paul Osborne
 */
public class AllMoviesEditableTableModel extends
    ...
    /**
     * Constructor for the table. Initialize the state of the model
     * and add listeners for changes to the model underlying this
     * model.
     */
     ...
     */
    public void cleanup() {
        MangoController.getInstance().removeMoviesChangeListener(
                moviesListener);
        for (Movie m : movies) {
            m.removeChangeListener(movieChangeListener);
        }
    ...
    public class AllMoviesChangeListener implements ChangeListener {
        public void stateChanged(ChangeEvent e) {
            ...
            AllMoviesEditableTableModel.this
