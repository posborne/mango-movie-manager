...
/**
 * ConstraintComboBoxModel is a DefaultComboBoxModel for the ComboBox
 * in a SavedSearchDialog.
 * 
 * @author Kyle Ronning
 */
public class ConstraintComboBoxModel extends DefaultComboBoxModel {
    ...
    /** List of constraints */
    private String[] constraints = { "Contains", "Does Not Contain",
    ...
    /**
     * @return the <code>Constraint</code> at the specified index in
     *         the model.
     */
    @Override
