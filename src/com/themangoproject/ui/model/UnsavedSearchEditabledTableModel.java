...
/**
 * UnsavedSearchEditabledTableModel is a table model for saved searches that
 * have not been saved yet.  It helps provide the user with an idea of what
 * the search picked up.
 * 
 * @author Paul Osborne
 */
public class UnsavedSearchEditabledTableModel extends SearchEditableTableModel {
	...
	private String searchQuery;
        ...
        /**
         * Constructs an unsaved saved search from a query <code>query</code>
         * 
	...
	public UnsavedSearchEditabledTableModel(String query) {
         ...
         * 
         * @return A list of 
         * @throws SQLException If the search is bad
         */
	@Override
