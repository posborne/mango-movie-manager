...
/**
 * Node with the action of setting the table to display all of the users owned
 * movies.
 * 
...
public class MyMoviesMutableTreeNode extends DefaultMutableTreeNode implements
	...
	/**
	 * Set the table to display all of the users movies (where owner = user).
	 */
	@Override
	public void doYourThing(Mango mangoPanel) {
		...
		String sql = "SELECT id FROM movie" + "	WHERE owner_id=" + ownerId;
