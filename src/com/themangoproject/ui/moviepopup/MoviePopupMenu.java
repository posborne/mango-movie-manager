...
/**
 * Popup menu for a movie item in a movie JTable. This has generic
 * options and actions that apply for any movies. Items can be added
    ...
    public MoviePopupMenu() {
        ...
        editMenuItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                MovieAddEditDialog maed = new MovieAddEditDialog(
                        UIController.getInstance().getMango(), true);
                maed.setLocationRelativeTo(UIController.getInstance()
                        .getMango());
                maed.populateData(m);
