...
public class H2ActorDAOTest extends TestCase {
    ...
    public void testGetAllActors() {
        ...
        String correctActors[] = { "Willis, Bruce",
                "Bedalia, Bonnie", "Gleason, Paul", "Irons, Jeremy",
                "Jackson, Samuel L.", "Greene, Graham" };
    ...
    public void testGetRolesForActor() {
        ...
        List<Role> bruceRoles = H2ActorDAO.getInstance()
                .getRolesForActor(bruce);
    ...
    public void testAddActor() {
        ...
        // Is it in there?
        List<String> actorNames = getActorListString(dao
                .getAllActors());
    ...
    public void testGetMoviesForActor() {
        ...
        assertTrue(movieStrings
                .contains("Die Hard: With a Vengeance"));
    }
