...
public class H2MovieDAOTest extends TestCase {
    ...
    public void testDeleteMovie() {
        ...
        assertTrue(movies.get(0).getTitle().equals(
    ...
    public void testGetGenresForMovie() {
        ...
        List<String> genres = H2MovieDAO.getInstance()
                .getGenresForMovie(dieHard);
    ...
    public void testGetActorsForMovie() {
        ...
        List<Actor> actors = H2MovieDAO.getInstance()
                .getActorsForMovie(dieHard);
        String dieHardActors[] = { "Willis", "Bedalia", "Gleason" };
    ...
    public void testGetMovieInfo() {
        ...
        assertEquals(new GregorianCalendar(2003, 11, 23).getTime(),
                dieHard.getPurchaseDate());
        ...
        assertTrue(dieHard.getOwner().getEmail().equals(
                "osbpau@bethel.edu"));
    ...
    public void testAddGenreToMovie() {
        ...
        H2MovieDAO.getInstance()
                .addGenreToMovie(dieHard, "New Genre");
        List<String> genres = H2MovieDAO.getInstance()
                .getGenresForMovie(dieHard);
    ...
    public void testRemoveGenreFromMovie() {
        ...
        H2MovieDAO.getInstance().removeGenreFromMovie(dieHard,
                "Action");
        List<String> genres = H2MovieDAO.getInstance()
                .getGenresForMovie(dieHard);
