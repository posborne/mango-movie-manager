...
public class H2PersonDAOTest extends TestCase {
    ...
    public void testAddPerson() {
        ...
        List<Person> people = H2PersonDAO.getInstance()
                .getAllPersons();
    ...
    public void testBorrowMovie() {
        ...
        assertTrue(((DBPerson) dieHard.getBorrower()).getId() == kyle
                .getId());
    }
    ...
    public void testGetAllPersons() {
        ...
        List<Person> people = H2PersonDAO.getInstance()
                .getAllPersons();
        String[] names = { "Paul Osborne", "Zachary Varberg",
                "Kyle Ronning" };
    ...
    public void testGetBorrowedMovies() {
        ...
        zach.setId(2);
        List<Movie> movies = H2PersonDAO.getInstance()
                .getBorrowedMovies(zach);
